# 📋 Dotazník pro Páju - Otázky na lepší přizpůsobení jídelníčku

Tento dotazník ti pomůže vytvořit jídelníček přesně podle tvých potřeb, preferencí a životního stylu.
...
### Oblíbená jídla
20. **Jaká jsou tvoje TOP 5 oblíbených jídel/receptů?**
...
21. **Jaká jídla bys chtěla jíst ČASTĚJI?** (ale teď je nemáš často na jídelníčku)

22. **Z jakých jídel jsi už UNAVENÁ?** (neměla bys je na jídelníčku)
...
1. **Ulož odpovědi** - buď vyplň interaktivní Python verzi (`python osoby/osoba_2/dotaznik_paja.py`) nebo si poznač odpovědi
2. **Dostaneš personalizovaná doporučení** - na základě odpovědí
3. **Vytvoříme přizpůsobený jídelníček** - šitý přesně na míru
4. **Optimalizujeme nákupy** - podle rozpočtu a obchodů
5. **Naplánujeme meal prep** - podle času a preferencí

---

## 📞 Kontakt

Pokud máš dotazy k dotazníku nebo potřebuješ pomoc s vyplněním, neváhej se zeptat!
