...
🕒 15:00-15:30 🥤 ODPOLEDNÍ SVAČINA
               ...
               └─ 288 kcal | 20.4g P | 2.7g F

🕡 18:30-19:00 🌙 VEČEŘE
               └─ Král sýrů 60g + Mascarpone 40g + Celer 150g + Olivy 30g
               └─ 308 kcal | 12.1g P | 5.3g F

🕘 21:00-21:30 🌃 VEČERNÍ SVAČINA (volitelná)
               └─ Jogurt hruška 140g + Dýňová semínka 10g
               └─ 140 kcal | 10.6g P | volitelná

               ────────────────────────────────────────
               CELKEM: 1502 kcal | 93.2g P | 57.3g S | 97.4g F
               
⚖️ Perfektní bilance všech makronutrientů! ✅
```
...
- **Perfektní makra**: 1502 kcal (100% cíle), 93g bílkovin (101%), 57g sacharidů (96%), 97g tuků (97%)
- **Vysoká vláknina**: 22.1g (110% cíle) - výborně pro trávení a sytost
- **Priorita expirujících položek**: Borůvky (dnes!), jogurty (do 25.1.), cottage cheese (do 23.1.)
- **Využití nových zásob**: Globus i proteiny/Mana z 20.01.
- **Rozmanitost**: Vejce, jogurty, sýry, ořechy, proteiny, zelenina, ovoce
- **Praktické**: Většinu lze připravit dopředu

### ⚠️ Na co dát pozor:

- **Borůvky vyprší dnes** - MUSÍ být spotřebovány při snídani
- **Jogurty s ovocem** - mají 7 dní do expirace, použít přednostně
- **Cottage cheese** - použit dnes, zbývá ještě 90g (vyprší za 5 dní)
- **Oběd v práci** - pokud má plnohodnotný oběd v práci, přeskoč domácí variantu

### 💡 Doporučení:

**Pokud má Pája oběd v práci**, celkový denní příjem bude:
- Snídaně (327) + Dopolední (261) + Odpolední (288) + Večeře (308) = **1184 kcal**
- Zbývá **324 kcal** na oběd v práci a večerní svačinu
- Večeři v práci zvolit s ~180-220 kcal (lehčí varianta)
- Nebo přidat večerní svačinu doma (140-180 kcal)

**Pokud nemá oběd v práci**, je plán kompletní s 1502 kcal.
